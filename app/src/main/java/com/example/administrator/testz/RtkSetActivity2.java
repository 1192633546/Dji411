...
public class RtkSetActivity2 extends AppCompatActivity implements BatteryState.Callback {
    /*
     * view
     */
    ...
    private TimerTask task = new TimerTask() {
        @Override
        public void run() {
            RtkSetActivity2.this.mBattery = DJISampleApplication.getBatteryInstance();
            if (mBattery != null) {
                mBattery.setStateCallback(RtkSetActivity2.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createFreTv = (TextView) findViewById(R.id.tv_create_fre);
        createTimeTv = (TextView) findViewById(R.id.tv_create_time);
        batteryFullChargeCapacityTv = (TextView) findViewById(R.id.bfcctv);
        batteryChargeRemainingTv = (TextView) findViewById(R.id.bcrtv);
        batteryChargeRemainingInPercentTv = (TextView) findViewById(R.id.bcriptv);
        batteryIsBeingChargedTv = (TextView) findViewById(R.id.bibctv);
        batterySelfHeatingStateTv = (TextView) findViewById(R.id.bshstv);
        batteryVoltageTv = (TextView) findViewById(R.id.bvtv);
        batteryCurrentTv = (TextView) findViewById(R.id.bctv);
        batteryLifetimeRemainingTv = (TextView) findViewById(R.id.blrtv);
        batteryTemperatureTv = (TextView) findViewById(R.id.bttv);
        batteryNumberOfDischargesTv = (TextView) findViewById(R.id.bnodtv);
        batterySnTv = (TextView) findViewById(R.id.tv_sn);
        //获取时间
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Toast.makeText(RtkSetActivity2.this, e.getMessage(), Toast.LENGTH_LONG).show();
                }
            }
        });
